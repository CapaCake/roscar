...
L1Controller::L1Controller()
{
    ...
    odom_sub = n_.subscribe("/encoder_imu_odom", 1, &L1Controller::odomCB, this);
    ...
    //Timer
    timer1 = n_.createTimer(ros::Duration((1)/controller_freq), &L1Controller::controlLoopCB, this); // Duration(0.05) -> 20Hz
    timer2 = n_.createTimer(ros::Duration((1)/controller_freq), &L1Controller::goalReachingCB, this); // Duration(0.05) -> 20Hz
