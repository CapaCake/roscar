...
(cl:defmethod tag-val ((m <Imu_0x91_msg>))
...
(cl:defmethod bitmap-val ((m <Imu_0x91_msg>))
...
(cl:defmethod id-val ((m <Imu_0x91_msg>))
...
(cl:defmethod time-val ((m <Imu_0x91_msg>))
...
(cl:defmethod frame_rate-val ((m <Imu_0x91_msg>))
...
(cl:defmethod acc_x-val ((m <Imu_0x91_msg>))
...
(cl:defmethod acc_y-val ((m <Imu_0x91_msg>))
...
(cl:defmethod acc_z-val ((m <Imu_0x91_msg>))
...
(cl:defmethod gyr_x-val ((m <Imu_0x91_msg>))
...
(cl:defmethod gyr_y-val ((m <Imu_0x91_msg>))
...
(cl:defmethod gyr_z-val ((m <Imu_0x91_msg>))
...
(cl:defmethod mag_x-val ((m <Imu_0x91_msg>))
...
(cl:defmethod mag_y-val ((m <Imu_0x91_msg>))
...
(cl:defmethod mag_z-val ((m <Imu_0x91_msg>))
...
(cl:defmethod eul_r-val ((m <Imu_0x91_msg>))
...
(cl:defmethod eul_p-val ((m <Imu_0x91_msg>))
...
(cl:defmethod eul_y-val ((m <Imu_0x91_msg>))
...
(cl:defmethod quat_w-val ((m <Imu_0x91_msg>))
...
(cl:defmethod quat_x-val ((m <Imu_0x91_msg>))
...
(cl:defmethod quat_y-val ((m <Imu_0x91_msg>))
...
(cl:defmethod quat_z-val ((m <Imu_0x91_msg>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Imu_0x91_msg>)))
  ...
  "50096650e969134198eb705461ee5445")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Imu_0x91_msg)))
  "Returns md5sum for a message object of type 'Imu_0x91_msg"
  "50096650e969134198eb705461ee5445")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Imu_0x91_msg>)))
  ...
  (cl:format cl:nil "#90 91 data_package~%Header header~%uint8 tag~%uint8 bitmap~%uint8 id~%uint32 time~%uint32 frame_rate~%float32 acc_x~%float32 acc_y~%float32 acc_z~%float32 gyr_x~%float32 gyr_y~%float32 gyr_z~%float32 mag_x~%float32 mag_y~%float32 mag_z~%float32 eul_r~%float32 eul_p~%float32 eul_y~%float32 quat_w~%float32 quat_x~%float32 quat_y~%float32 quat_z~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Imu_0x91_msg)))
  "Returns full string definition for message of type 'Imu_0x91_msg"
  (cl:format cl:nil "#90 91 data_package~%Header header~%uint8 tag~%uint8 bitmap~%uint8 id~%uint32 time~%uint32 frame_rate~%float32 acc_x~%float32 acc_y~%float32 acc_z~%float32 gyr_x~%float32 gyr_y~%float32 gyr_z~%float32 mag_x~%float32 mag_y~%float32 mag_z~%float32 eul_r~%float32 eul_p~%float32 eul_y~%float32 quat_w~%float32 quat_x~%float32 quat_y~%float32 quat_z~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
